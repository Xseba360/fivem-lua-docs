...
--- See [`TASK_START_SCENARIO_IN_PLACE`](https://docs.fivem.net/natives/?_0x142A02425FF02BD9) for a list of scenarios.
---
...
--- Gives the ped a helmet. Can be removed by invoking [`REMOVE_PED_HELMET`](https://docs.fivem.net/natives/?_0xA7B2458D0AD6DED8).
--- 
--- ```cpp
--- enum ePedCompFlags {
---   PV_FLAG_NONE                  = 0, // 0
...
--- @return void
--- @overload fun(ped: Ped, bEnable: boolean): void
...
--- NativeDB Introduced: v323
--- ```
--- @usage -- Define a table with color names mapped to their corresponding palette indices for phone colors
--- local PhoneColors = {
---     Blue = 0,
---     Green = 1,
---     Red = 2,
...
--- # New Name: SetPedPhonePaletteIdx
--- Sets the palette index of a ped's phone.
--- 
--- | Value | Color      |
--- | :---: | :-----:    |
...
--- @overload fun(ped: Ped, index: number): void
--- @deprecated
function N_0x83a169eabcdb10a2(ped, index) end
...
--- @return boolean
--- @overload fun(minX: number, minY: number, minZ: number, maxX: number, maxY: number, maxZ: number, bHighlightArea: boolean, bDo3DCheck: boolean): boolean
...
--- NativeDB Introduced: v323
--- ```
--- @usage -- Points the right arm to -1849.0, -1231.0, 13.0 for 10 seconds
...
--- @param offsetY number (float)
--- @param offsetZ number (float)
--- @param ikTargetFlags number (int)
--- @param blendInDuration number (int)
--- @param blendOutDuration number (int)
--- @return void
--- @overload fun(ped: Ped, ikIndex: number, entityLookAt: Entity, boneLookAt: number, offsetX: number, offsetY: number, offsetZ: number, ikTargetFlags: number, blendInDuration: number, blendOutDuration: number): void
...
--- ```
---
--- @hash [0xC73EFFC5E043A8BA](https://docs.fivem.net/natives/?_0xC73EFFC5E043A8BA)
---
--- @return void
--- @overload fun(): void
...
--- @param updateState number (int)
--- @param forceAIPreCameraUpdate boolean
--- @return boolean
--- @overload fun(ped: Ped, motionStateHash: Hash, shouldReset: boolean, updateState: number, forceAIPreCameraUpdate: boolean): boolean
...
--- @return void
--- @overload fun(ped: Ped, noCollisionUntilClear: boolean): void
function SpecialFunctionDoNotUse(ped, noCollisionUntilClear) end

    
--- # New Name: SpecialFunctionDoNotUse
--- Kicks the ped from the current vehicle and keeps the rendering-focus on this ped (also disables its collision). If doing this for your player ped, you'll still be able to drive the vehicle.\
--- Only to be used in very specific situations where the ped needs to be inside the car still but not attached.
---
--- @hash [0xF9ACF4A08098EA25](https://docs.fivem.net/natives/?_0xF9ACF4A08098EA25)
...
--- @overload fun(ped: Ped, noCollisionUntilClear: boolean): void
--- @deprecated
function N_0xf9acf4a08098ea25(ped, noCollisionUntilClear) end
...
--- @usage -- This sets the minimum stun ground time for the player's ped to 10 seconds (and re-applies it if the player's ped changes)
--- 
--- local currentPed = 0
...
--- @param ped Ped
--- @param minTimeInMs number (int)
--- @return void
--- @overload fun(ped: Ped, minTimeInMs: number): void
