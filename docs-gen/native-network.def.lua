...
--- Fade the given entity back in, usually used after the entity has been faded out with [NETWORK_FADE_OUT_ENTITY](https://docs.fivem.net/natives/?_0xDE564951F95E09ED)
--- 
...
--- @usage function GetPlayerInstance(player)
...
--- @return void
--- @overload fun(player: Player, toggle: boolean, bAllowDamagingWhileConcealed: boolean): void
