...
--- @param roomIndex number (int)
--- @return Hash
--- @overload fun(interiorId: number, roomIndex: number): Hash
...
--- @param jsonString string (char*)
--- @return boolean
--- @overload fun(jsonString: string|JsonString<any>): boolean
